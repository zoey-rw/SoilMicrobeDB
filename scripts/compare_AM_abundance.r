...
# Note: Figure 5b is now generated by compare_ecto_tree_abundance.r
# This plot (p1) is kept for exploration/supplemental purposes
...
# Struo2 file used for exploration/validation (optional - commented out as file may not be available locally)
