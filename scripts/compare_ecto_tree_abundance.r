...
# Figure 5 (combined)
# Note: fig_5a is generated by scripts/compare_its.r
# If fig_5a doesn't exist, source compare_its.r to generate it
if(!exists("fig_5a")) {
    cat("⚠️  fig_5a not found in environment. Running scripts/compare_its.r to generate it...\n")
    source("scripts/compare_its.r")
}
...
if(exists("fig_5a")) {
    ...
    cat("⚠️  Error: Could not generate fig_5a. Please check scripts/compare_its.r\n")
}
