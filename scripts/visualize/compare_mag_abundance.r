...
# Generated by scripts/summarize_outputs/01_calculate_sequencing_depth.r
...
# Generated by scripts/summarize_outputs/08_summarize_pct_filtered.r
filter_results = read_csv("data/classification/analysis_files/pass_filter_summary.csv", show_col_types = FALSE) %>% filter(metric=="percent_classified" & db_name == "soil_microbe_db") %>% select(-1)

# Read in MAG abundances
# Generated by scripts/summarize_outputs/09_add_mag_source_info.r
