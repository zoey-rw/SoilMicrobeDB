...
# Generated by scripts/summarize_outputs/11_merge_its_metagenome_genus.r
df_compare <- read_csv("data/classification/analysis_files/genus_ITS_metagenome_comparison.csv")
...
# Save figure
ggsave("manuscript_figures/fig5a.png", fig_5a, width = 12, height = 8, units = "in", dpi = 300)
